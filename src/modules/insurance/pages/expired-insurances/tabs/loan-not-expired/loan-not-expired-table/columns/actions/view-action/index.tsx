            ...
            <DetailSectionGroup>
              ...
              >
                ...
                <DetailField
                  ...
                  value={`${formatDate(rowData.riskStartDate, "PP")} -
                        ${formatDate(rowData.riskMaturityDate, "PP")}`}
                />
              </DetailsSection>
              ...
              <DetailsSection title="Important Dates">
                {rowData.riskStartDate && (
                  <DetailField
                    ...
                    value={`${formatDate(rowData.riskStartDate, "PPP")}`}
                  />
                )}
                ...
                {rowData.riskMaturityDate && (
                  <DetailField
                    ...
                    className="ml-4 font-medium"
                    value={`${formatDate(rowData.riskMaturityDate, "PPP")}`}
                  />
                )}
              </DetailsSection>
            </DetailSectionGroup>
