  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "dark:data-active:text-foreground dark:data-active:border-input data-active:bg-primary data-active:text-primary-foreground data-active:text-primary-foreground",
