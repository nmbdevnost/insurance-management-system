export const editorTheme = {
  ...
  contentEditable:
    "outline-none text-xl leading-relaxed text-foreground font-system focus:outline-none w-full!",
  ...
  // heading: {
  //   h1: "font-bold mb-6 mt-8 first:mt-0 text-foreground",
  ...
  sourceView: {
    textarea:
      "w-full h-full p-4 bg-background border-none rounded-none font-mono text-sm resize-none focus:outline-none focus:ring-0",
  },
};
